...
<div class="card">
    <div class="card p-2">
        <div class="card-body p-4">
            <h5 class="mb-4">Form Pengeditan Branch</h5>

            <form action="{{ route('master.branch.update', $branch->id) }}" method="POST">
                @csrf
                @method('PATCH')
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="d-md-flex d-grid align-items-center gap-3">
                            ...
                            <a href="{{ route('master.branch.index') }}" class="btn btn-secondary px-4">Cancel</a>
                        </div>
                    </div>
                </div>
            </form>
