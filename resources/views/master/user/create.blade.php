        ...
        <div class="card-body p-4">
            ...
            <form action="{{ route('user.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <div class="position-relative input-icon">
                            <input type="text" class="form-control" id="phone_number" name="phone_number" placeholder="Nomor handphone" value="{{ old('phone_number') }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        <select class="form-select" id="role_name" name="role_name">
                            <option value="" {{ old('role_name') ? '' : 'selected' }}>Pilih Role</option>
                            <option value="admin" {{ old('role_name') == 'admin' ? 'selected' : '' }}>Admin</option>
                            <option value="teknisi" {{ old('role_name') == 'teknisi' ? 'selected' : '' }}>Teknisi</option>
                        </select>
                        @error('role_name')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
